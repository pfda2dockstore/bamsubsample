# Generated by precisionFDA exporter (v1.0.3) on 2018-06-14 16:47:20 +0000
# The asset download links in this file are valid only for 24h.

# Exported app: bamsubsample, revision: 1, authored by: bahram.kermani
# https://precision.fda.gov/apps/app-Bv0BGy005X5fY5ZqKVyYxkyj
...
# Download app assets
RUN curl https://dl.dnanex.us/F/D/VyKGj7v0jkq2X1xjZ42fvPZvfKk5qq33zfjj5fK1/samtools-1.3.tar.gz | tar xzf - -C / --no-same-owner --no-same-permissions
...
RUN ["/bin/bash","-c","echo -E \\{\\\"spec\\\":\\{\\\"input_spec\\\":\\[\\{\\\"name\\\":\\\"nameBam\\\",\\\"class\\\":\\\"file\\\",\\\"optional\\\":false,\\\"label\\\":\\\"Name\\ BAM\\\",\\\"help\\\":\\\"\\\"\\},\\{\\\"name\\\":\\\"nameBamSubsampled\\\",\\\"class\\\":\\\"string\\\",\\\"optional\\\":false,\\\"label\\\":\\\"Name\\ BAM\\ Subsampled\\\",\\\"help\\\":\\\"\\\"\\},\\{\\\"name\\\":\\\"x\\\",\\\"class\\\":\\\"float\\\",\\\"optional\\\":false,\\\"label\\\":\\\"X\\\",\\\"help\\\":\\\"\\\"\\}\\],\\\"output_spec\\\":\\[\\{\\\"name\\\":\\\"nameReturn\\\",\\\"class\\\":\\\"file\\\",\\\"optional\\\":false,\\\"label\\\":\\\"Name\\ Return\\ File\\\",\\\"help\\\":\\\"\\\"\\}\\],\\\"internet_access\\\":false,\\\"instance_type\\\":\\\"baseline-8\\\"\\},\\\"assets\\\":\\[\\\"file-BpBpb580qVbPkG0711FzfBYk\\\"\\],\\\"packages\\\":\\[\\]\\} \u003e /spec.json"]
RUN ["/bin/bash","-c","echo -E \\{\\\"code\\\":\\\"samtools\\ view\\ -s\\ \\$x\\ -b\\ \\\\\\\"\\$nameBam_path\\\\\\\"\\ \\\\u003e\\ \\\\\\\"\\$nameBamSubsampled\\\\\\\"\\\\nemit\\ nameReturn\\ \\\\\\\"\\$nameBamSubsampled\\\\\\\"\\\"\\} | python -c 'import sys,json; print json.load(sys.stdin)[\"code\"]' \u003e /script.sh"]
